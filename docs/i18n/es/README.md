# Zingers: documentación

> **Empieza aquí si eres nuevo:** [vocabulary.md](./vocabulary.md) (nomenclatura) →
> [design-vision.md](./design-vision.md) (estrella polar Flight-First) →
> [game-spec.md](./game-spec.md) (bucle y escenarios) → [bible/](./bible/) (lore).
> Plan de desarrollo activo: [flight-first-plan.md](./flight-first-plan.md).

Sitio público: **[zingers.org](https://zingers.org)** (registro: `lib/org/registry.ts`).

## Presentaciones del producto (zingers.org)
...
| Doc | Propósito |
|-----|---------|
| [bible/README.md](./bible/README.md) | Índice + disciplina canónica |
