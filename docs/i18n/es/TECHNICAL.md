...
- **Identidad del Entrenador.** Los nombres únicos pueden vincularse a una wallet Solana opcional (solo prueba de propiedad. Sin gasto). Los tableros de Circuit/Climb resuelven las etiquetas en el servidor.
