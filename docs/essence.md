...
- **Depth is soul → shared, cross-device.** "How high you climbed above the Long
  ...
  **depth → Trainer Rank + a Flight sigil baked onto the champion's body.** One
  identity, everywhere.
...
Trainer Rank (eternal), Crowns, Clan allegiance, and the rating board outcomes.
...
1. **Spectating duration.** A 6-minute live fight is a hard sell on a phone. The
   ...
   desktop's is the **full live fight**. This is exactly the earlier instinct that
