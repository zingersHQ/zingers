...
> **In short:** Every champion doubles as a collectible card, and the art on that
> card changes as the champion fights and grows. You collect a growing dex, raise
> a stable, and (later) trade.
...
Rarity is **earned, then scarce**. It is not a random pull. It rises with the
...
| **Mythic** | Legend + a season title (e.g. won a season, sealed a Chronicle feat) | one-of-a-kind events; the trophy tier |
