"use client";
// The Scrying Gallery — the autonomous league. Agents fight each other around
// the clock; the ladder and result feed move live while you watch. Lived at
// /league as a flat page; now an in-world overlay opened from the Gallery board
// in the Concord, so "the world fights without you" happens inside the world.
...
export function LeagueSheet({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      <div
        ...
        style={{ ["--ac" as string]: "#ff6b4a", position: "relative", width: "min(1080px, 96vw)", maxHeight: "92vh", overflow: "auto", padding: 24, borderColor: "#ff6b4a" }}
      >
        ...
        <div style={{ display: "flex", alignItems: "flex-end", gap: 14, flexWrap: "wrap", paddingRight: 28 }}>
          <div>
            <h1 style={{ fontSize: 26, fontWeight: 700, margin: 0 }}>The Scrying Gallery</h1>
