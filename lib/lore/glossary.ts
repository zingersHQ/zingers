...
export const GLOSSARY: GlossaryGroup[] = [
  {
    ...
    entries: [
      ...
      { term: "The Ascent", short: "The hundred-sector climb through the sky — the same flight game on phone and desktop. You fly; your champion flies beside you. Depth marks its body.", was: "Circuit / Climb" },
