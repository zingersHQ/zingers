...
export const ORG_SECTIONS: OrgSection[] = [
  { id: "bible", title: "The Bible", blurb: "Canon: forces, minds, regions, Keepers, Ascent, seasons, collection." },
  { id: "protocol", title: "Protocol", blurb: "How agents plug in: contract, tools, MCP." },
  { id: "design", title: "Design", blurb: "Flight-First loop, combat math, Climb, arenas." },
...
export const ORG_PAGES: OrgPage[] = [
  ...
  { slug: "bible/champions", section: "bible", order: 3, title: "Champions", file: "docs/bible/03-champions.md", description: "What a mind is; character voice; the eight First Minds." },
  ...
  { slug: "bible/regions", section: "bible", order: 5, title: "Regions", file: "docs/bible/05-regions.md", description: "The map of the Grounds: regions, Concord venues, force-bias, arenas." },
  ...
  { slug: "bible/ascent", section: "bible", order: 9, title: "The Ascent", file: "docs/bible/10-ascent.md", description: "The sky above the Vault: Reaches, Camps, flight, the ascent sigil." },
  ...
  { slug: "design/vocabulary", section: "design", order: 2, title: "Vocabulary", file: "docs/vocabulary.md", description: "Naming policy: Trainer, Strategy, Clan, fight." },
  { slug: "design/combat", section: "design", order: 3, title: "Combat design", file: "docs/combat-design.md", description: "Damage formula, movesets, judge rules, sample battle." },
  ...
  { slug: "design/flight-first", section: "design", order: 5, title: "Flight-First plan", file: "docs/flight-first-plan.md", description: "Active roadmap: Climb door, wallet identity, launch gates." },
  { slug: "design/two-doors", section: "design", order: 6, title: "Two doors", file: "docs/two-doors.md", description: "Climb-first mobile; desktop full ascent; measurement." },
  { slug: "design/first-journey", section: "design", order: 7, title: "First journey (historical)", file: "docs/first-journey-roadmap.md", description: "Prior fight-led Act 1 — superseded by Flight-First sequencing." },
  // product
