...
export const ORG_PAGES: OrgPage[] = [
  ...
  { slug: "design/first-journey", section: "design", order: 3, title: "First journey (Act 1)", file: "docs/first-journey-roadmap.md", description: "Onboarding flow from first visit through Concord landing." },
  // product
